// *********************************************************************** Assembly :
// dotNetTips.Utility.Core Author : David McCarter Created : 07-29-2016
//
...
namespace dotNetTips.Utility.Core.Collections
{
    /// <summary>
    ...
    /// <seealso cref="dotNetTips.Utility.Core.ICloneable{T}"/>
    public class DistinctBlockingCollection<T> : BlockingCollection<T>, ICloneable<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistinctBlockingCollection(Of T)"/> class.
        /// </summary>
