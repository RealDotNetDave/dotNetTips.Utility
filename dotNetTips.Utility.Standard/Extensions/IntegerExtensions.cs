...
namespace dotNetTips.Utility.Standard.Extensions
{
    ...
    public static class IntegerExtensions
    {
        ...
        public static Boolean Between(this Int32 theNumber, Int32 lower, Int32 upper) => theNumber >= lower && theNumber <= upper;
        /// <summary>
        ...
        /// <param name="theNumber">Number to process</param>
        /// <returns>True/False</returns>
        public static Boolean IsEven(this Int32 theNumber) => (theNumber % 2) == 0;
        /// <summary>
        ...
        public static String ToStringOrEmpty(this Int32 theNumber, Int32 upto = 0, Int32 beyond = 9000, String defaultText = "") => theNumber <= upto || theNumber > beyond
                ? defaultText
