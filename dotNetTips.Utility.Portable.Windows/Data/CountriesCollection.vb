...
Namespace Data
    ...
    Public NotInheritable Class CountriesCollection
        ...
        Private Shared Function ConvertCountries(nameOrCode As String, countryResult As String) As String
            Return ParseCountryCodes(nameOrCode, countryResult)
        End Function
        ...
        Friend Shared Function ParseCountryCodes(nameOrCode As String, ByRef countryResult As String) As String
